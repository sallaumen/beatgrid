...
Mox.defmock(Beatgrid.Audio.MarkerDetectorMock, for: Beatgrid.Audio.MarkerDetector)
...
Mox.defmock(Beatgrid.Video.FrameSamplerMock, for: Beatgrid.Video.FrameSampler)
Mox.defmock(Beatgrid.Recognition.Mock, for: Beatgrid.Recognition)
